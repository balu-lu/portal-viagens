    ...
    <div className={styles.container}>
      ...
      <div className={styles.infoGrid}>
        <div className={styles.infoItem}>
          <span className={styles.infoLabel}>Preço Médio Estimado</span>
          <span className={styles.infoValue}>{destino.precoViagem}</span>
        </div>
        <div className={styles.infoItem}>
          <span className={styles.infoLabel}>Duração Sugerida</span>
          <span className={styles.infoValue}>{destino.diasDisponiveis}</span>
        </div>
      </div>
