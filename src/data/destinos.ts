...
export const destinos: Destino[] = [
    {
        ...
        descricao:
            'Descubra a magia dos templos ancestrais, jardins zen e a deslumbrante época das cerejeiras em flor.',
        precoViagem: 'R$ 8.500',
    ...
    },
    {
        ...
        descricao:
            'Pôr do sol inesquecível, águas cristalinas do Mar Egeu e a arquitetura branca de cúpulas azuis.',
        precoViagem: 'R$ 7.200',
    ...
    },
    {
        ...
        descricao:
            'Uma jornada mística aos Andes para explorar a cidade perdida dos Incas, cercada por montanhas majestosas.',
        precoViagem: 'R$ 3.800',
    ...
    },
    {
        ...
        descricao:
            'Mergulhe na profunda história da formação do Brasil. Uma cidade colonial marcada pela extração do ouro, arquitetura barroca e uma rica memória material.',
        precoViagem: 'R$ 2.500',
